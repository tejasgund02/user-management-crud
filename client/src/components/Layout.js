      ...
      <div className="app-body">
        <aside className="sidebar slide-in-left">
          ...
          <ul className="social-links">
            <li><a className="sidebar-btn" href="https://www.linkedin.com/in/tejas-gund/" target="_blank" rel="noopener noreferrer">LinkedIn</a></li>
            <li><a className="sidebar-btn" href="https://www.youtube.com/" target="_blank" rel="noopener noreferrer">YouTube</a></li>
            <li><a className="sidebar-btn" href="https://www.instagram.com/_tejas___g/" target="_blank" rel="noopener noreferrer">Instagram</a></li>
          </ul>
        </aside>
